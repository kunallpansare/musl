...
// // ------------------------------------------------------------------
// // Define a macro for the simulated SMC call overhead in microseconds.

// #define SMC_CALL_OVERHEAD_US 190

// // ------------------------------------------------------------------
// // We define a single global variable that records the last path ID.
// // 'volatile' to help prevent aggressive compiler optimizations.

// volatile int64_t g_last_path_id = 0;

// // ------------------------------------------------------------------
// // Simple function to simulate an SMC call by burning CPU cycles
// // in a busy loop. For a real TEE call, you'd use the actual SMC
// // instruction or system call. Here we just approximate 190 us.

// static inline void simulate_smc_call_delay(void)
// {
//     // This constant is purely illustrative. You must tune it for your system.
//     // The goal is to produce ~190 microseconds of busy waiting.
//     // For demonstration, we just do a for-loop. Adjust as needed.
    
//     // On some systems, you might need more or fewer iterations.
//     // You could also measure real time in a more robust approach.
//     const volatile int burn_iterations = 200000; // Example guess
...
// // ------------------------------------------------------------------
// // We keep the same 'init_table' signature, but return NULL (dummy pointer).
...
// // ------------------------------------------------------------------
// // Instead of incrementing an entry in a per-function table, 
// // just update our global variable. Then simulate the SMC call.

// void inc_table_entry(void* dummy_table, int i) {
//     (void)dummy_table;   // unused
//     g_last_path_id = i;

//     // Simulate the time it would take to make an SMC call
//     simulate_smc_call_delay();
// }
